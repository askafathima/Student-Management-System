...
namespace StudentsManagementSystem {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string StudentName, string Gender, long PhoneNo, string FatherName) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public long PhoneNo {
                get {
                    return ((long)(this[this.tableStudents.PhoneNoColumn]));
                }
                set {
...
namespace StudentsManagementSystem.DataSet3TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentID] = @Original_StudentID) AND ([Stu" +
                "dentName] = @Original_StudentName) AND ([Gender] = @Original_Gender) AND ([Phone" +
                "No] = @Original_PhoneNo) AND ([FatherName] = @Original_FatherName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([StudentName], [Gender], [PhoneNo], [FatherName]) V" +
                "ALUES (@StudentName, @Gender, @PhoneNo, @FatherName);\r\nSELECT StudentID, Student" +
                "Name, Gender, PhoneNo, FatherName FROM Students WHERE (StudentID = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentName] = @StudentName, [Gender] = @Gender, [PhoneNo] = @PhoneNo, [FatherName] = @FatherName WHERE (([StudentID] = @Original_StudentID) AND ([StudentName] = @Original_StudentName) AND ([Gender] = @Original_Gender) AND ([PhoneNo] = @Original_PhoneNo) AND ([FatherName] = @Original_FatherName));
SELECT StudentID, StudentName, Gender, PhoneNo, FatherName FROM Students WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentsManagementSystem.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, StudentName, Gender, PhoneNo, FatherName FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentID, string Original_StudentName, string Original_Gender, long Original_PhoneNo, string Original_FatherName) {
        ...
        public virtual int Insert(string StudentName, string Gender, long PhoneNo, string FatherName) {
            if ((StudentName == null)) {
        ...
        public virtual int Update(string StudentName, string Gender, long PhoneNo, string FatherName, int Original_StudentID, string Original_StudentName, string Original_Gender, long Original_PhoneNo, string Original_FatherName, int StudentID) {
            if ((StudentName == null)) {
                throw new global::System.ArgumentNullException("StudentName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((long)(Original_PhoneNo));
            if ((Original_FatherName == null)) {
                throw new global::System.ArgumentNullException("Original_FatherName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, string Gender, long PhoneNo, string FatherName, int Original_StudentID, string Original_StudentName, string Original_Gender, long Original_PhoneNo, string Original_FatherName) {
            return this.Update(StudentName, Gender, PhoneNo, FatherName, Original_StudentID, Original_StudentName, Original_Gender, Original_PhoneNo, Original_FatherName, Original_StudentID);
        }
    }
